...
<aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu"><br>
            ...
            <li><a class="nav-link" href="ls_request.php"><i class="fas fa-users"></i> <span>List of Request (Unpaid)</span></a></li>
            <li><a class="nav-link" href="lsct.php"><i class="fas fa-users"></i> <span>List of Request (Paid)</span></a></li>
            <!-- <li><a class="nav-link" href="lsr.php"><i class="fas fa-users"></i> <span>Student Reschedule</span></a></li> -->
            <!-- <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i><span>Student Request</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="ls_request.php">List of Student Request</a></li>
                <li><a class="nav-link" href="lsct.php">Student Complete Transactions </a></li>
                <li><a class="nav-link" href="lsr.php">Student Reschedule </a></li>
              </ul>
            </li> -->
