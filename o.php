...
<form method="get" action="student_info.php" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
    <div class="input-group input-group-lg">
        ...
        <input name="student_vcode" type="search" class="form-control" id="student_vcode" placeholder="Enter the Credentials Code" aria-label="Search" oninput="validateNumberInput(this)">
