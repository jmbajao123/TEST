...
<head>
  ...
  <title>List of Request Documents - Credentials Verification Sibugay Technical Institute Inc.</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>List of Request Documents</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"> <a href="dashboard.php"> Dashboard </a> </div>
              <!-- <div class="breadcrumb-item"><a href="#">Department List</a></div> -->
              <div class="breadcrumb-item">List of Request Documents
...
// ✅ Fetch total records count but only with status = 'Request Documents'
$total_sql = "SELECT COUNT(*) AS total FROM request WHERE status = 'Request Documents'";
...
// ✅ Fetch data with pagination, filter by status = 'Request Documents'
$sql = "
    ...
    WHERE r.status = 'Request Documents'   -- ✅ filter
            ...
            <table class="table table-striped table-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="request_info.php?req_id=<?= $row['req_id']; ?>" class="btn btn-outline-info btn-sm">
                    ...
                    <tr>
                        <td colspan="7" class="text-center">No Request Documents record found</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<div class="mt-2 text-muted">
    <strong>Total Requests: <?= $total_records; ?></strong>
</div>
