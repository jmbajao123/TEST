...
<head>
  ...
  <title>List of Release Documents - Credentials Verification Sibugay Technical Institute Inc.</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>List of Release Documents</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"> <a href="dashboard.php"> Dashboard </a> </div>
              <!-- <div class="breadcrumb-item"><a href="#">Department List</a></div> -->
              <div class="breadcrumb-item">List of Release Documents
...
// ✅ Fetch total records count but only with status = 'Release Documents'
$total_sql = "SELECT COUNT(*) AS total FROM request WHERE status = 'Release Documents'";
...
// ✅ Fetch data with pagination, filter by status = 'Release Documents'
$sql = "
    SELECT r.req_id, r.req_referrence, r.total_payment, r.payment_status, r.status,
           CONCAT(s.first_name, ' ',
    ...
    WHERE r.status = 'Release Documents'   -- ✅ filter
                ...
                <tbody>
                    <?php if (mysqli_num_rows($result) > 0): 
                        ...
                        while ($row = mysqli_fetch_assoc($result)): 
                            $status_badge = ($row['payment_status'] == 'Paid') ? 'badge-success' : 'badge-danger';
                    ?>
                    <tr>
                        <td><?= htmlspecialchars($row['req_referrence']); ?></td>
                        <td><?= htmlspecialchars($row['full_name']); ?></td>
                        <td><span>₱ </span><?= number_format($row['total_payment'], 2); ?></td>
                        <td><div class="badge <?= $status_badge; ?>"><?= htmlspecialchars($row['payment_status']); ?></div></td>
                        <td><?= htmlspecialchars($row['status']); ?></td>
                        <td>
                            <a href="release_info.php?req_id=<?= $row['req_id']; ?>" class="btn btn-outline-info btn-sm">
                    ...
                    <tr>
                        <td colspan="7" class="text-center">No Release Documents record found</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<div class="mt-2 text-muted">
    <strong>Total Release Documents: <?= $total_records; ?></strong>
</div>
