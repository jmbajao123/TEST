...
<head>
  ...
  <title>Release Documents Information &mdash; Barangay Information System</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Release Documents Information</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="dashboard.php">Dashboard</a></div>
              <div class="breadcrumb-item">Release Documents Information</div>
            </div>
          </div>
              ...
              <div class="col-12 col-lg-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <div class="col-lg-12">
                        <h2>Release Documents Information</h2>
                    </div>
                  </div>
                  <div class="card-body">
<?php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
    ...
    if ($req_id > 0) {
        $update_query = "UPDATE request SET status = ?, a_id = ? WHERE req_id = ?";
...
<form method="post" action="request_info.php">
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-12">
                <a href="list_request_release.php" class="btn btn-outline-secondary">Back</a>
            </div>
        </div>
    </div>
</form>
